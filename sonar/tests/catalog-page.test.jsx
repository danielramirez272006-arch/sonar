...
it('creates an announcement, preserves the editor on failure and confirms deletion', async () => {
  ...
  fireEvent.change(screen.getByLabelText('Resumen de la noticia *'), { target: { value: 'Texto' } })
  fireEvent.change(screen.getByLabelText('Fecha de publicación *'), { target: { value: '2026-10-01' } })
  fireEvent.change(screen.getByLabelText('Visible hasta (opcional)'), { target: { value: '2026-10-31' } })
