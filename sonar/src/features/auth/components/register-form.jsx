...
import { ArrowRight, Check, Eye, EyeOff, Headphones, Music2, Sparkles, User, Disc3, ShieldCheck } from 'lucide-react';
      ...
      <section className="auth-form-area" aria-labelledby="register-title">
        <div className="auth-form-wrap">
          ...
          <header className="auth-heading">
            ...
            <p>Comienza tu diario sonoro y personaliza tu perfil de melómano.</p>
          </header>
          ...
          <form className="auth-form" onSubmit={handleSubmit}>
            ...
            <label htmlFor="register-password" style={{ marginTop: '0.2rem' }}>Contraseña</label>
